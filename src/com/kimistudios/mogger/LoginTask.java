...
public class LoginTask extends AsyncTask<String, Void, Integer> {
	...
	protected Integer doInBackground(String... arg0) {
		EditText userName = (EditText)activity.findViewById(R.id.logemail);
		EditText passwordEdit = (EditText)activity.findViewById(R.id.logpass);
	...
	protected void onPostExecute(Integer responseCode)
	{
		...
		if (responseCode == 1) {
			...
			Intent i = new Intent();
			i.setClass(activity.getApplicationContext(), Dashboard.class);
